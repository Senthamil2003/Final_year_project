...
export default function Report({item}) {
  ...
  return (
    ...
    <div  style={{ textAlign: 'center', padding: '40px', border: '1px solid #ccc', borderRadius: '10px', maxWidth: '600px', boxShadow: '0 0 10px rgba(0, 0, 0, 0.1)', backgroundColor: '#fff' }}>
      ...
      <button style={{ background: '#007bff', color: '#fff', padding: '10px 20px', border: 'none', borderRadius: '5px', cursor: 'pointer', transition: 'background 0.3s', fontSize: '18px', marginRight: '10px' }} >
        Print Report
      </button>
